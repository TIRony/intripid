  ...
  return (
    <div className="relative overflow-hidden  bg-pattern1">
      <img
        ...
        className="absolute hidden x:block -right-[55px] top-0"
        alt="dots"
      />
      <div
        className={[
          "flex flex-col relative py-10 sm:py-[60px] x:py-[66px] x:items-end",
          Padding,
          maxWidth,
        ].join(" ")}
      >
        <img
          ...
          className="max-w-full absolute -left-[410px] w-[671px] -top-[70px] z-0 x:left-[50px]"
          alt="people"
        />

        <div className="sm:ml-[85px] flex flex-col gap-6 items-start relative z-10  x:items-end x:w-[570px]">
          ...
          <Button
            variant="Primary-A"
            classname="h-[59px] w-[310px] sm:w-[240px] x:w-[297px] x:self-start"
          >
