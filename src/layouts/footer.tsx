...
const Footer = () => {
  return (
    <div
      className={[
        Padding,
        "flex flex-col pt-20 pb-10 sm:pb-6 bg-background-lightBlue max-w-mobile sm:max-w-tablet w-full mx-auto x:max-w-desktop-s 2xl:max-w-desktop-5xl",
      ].join(" ")}
    >
      <div className="flex flex-col gap-10 sm:gap-20 x:flex-row">
        <div className="flex flex-col gap-6 max-w-[312px] w-full sm:max-w-[384px] items-center sm:items-start">
          ...
          <div className="flex flex-col gap-10">
            <Typography variant="body300" classname="text-primary-brand">
              An online platform that encourages travel by removing stress from
        ...
        <div className="flex flex-wrap gap-4  gap-y-10 x:gap-x-8">
          <div className="flex flex-col w-[148px] gap-4 sm:w-[311px] sm:gap-8 x:w-[224px]">
      ...
      <div className="flex sm:justify-between mt-10 sm:mt-20 flex-col sm:flex-row items-center gap-y-4">
